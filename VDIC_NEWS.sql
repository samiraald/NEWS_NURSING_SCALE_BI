CREATE OR REPLACE VIEW VDIC_NEWS (
   CD_PACIENTE
  ,CD_ATENDIMENTO
  ,NM_PACIENTE
  ,DT_ATENDIMENTO
...
SELECT
      ...
      ,to_char(COLETA_SINAL_VITAL.DATA_COLETA,'DD/MM/YYYY') "DATA"
      ,COLETA_SINAL_VITAL.DATA_COLETA  "Data/Hora da Coleta"
...
GRANT SELECT ON VDIC_NEWS TO biconexao;
GRANT SELECT ON VDIC_NEWS TO dbacp WITH GRANT OPTION;
GRANT SELECT ON VDIC_NEWS TO dbaportal WITH GRANT OPTION;
GRANT DELETE,INSERT,SELECT,UPDATE ON VDIC_NEWS TO dbaps;
GRANT DELETE,INSERT,SELECT,UPDATE ON VDIC_NEWS TO dbasgu;
GRANT DELETE,INSERT,SELECT,UPDATE ON VDIC_NEWS TO mv2000;
GRANT DELETE,INSERT,SELECT,UPDATE ON VDIC_NEWS TO mvintegra